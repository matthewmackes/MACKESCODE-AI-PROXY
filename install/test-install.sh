...
echo -e "\nRuntime packages and assets (required — V2 imports backend.v2 and src.console services):"
check_dir "/usr/lib/matts-value-set/src"
check_dir "/usr/lib/matts-value-set/backend"
check_dir "/usr/lib/matts-value-set/frontend"
check_dir "/usr/lib/matts-value-set/config"
check_file "/usr/lib/matts-value-set/src/console/handlers/api_handler.py"
check_file "/usr/lib/matts-value-set/backend/v2/app.py"
check_file "/usr/lib/matts-value-set/frontend/dist/index.html"
