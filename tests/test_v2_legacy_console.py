...
class V2LegacyConsoleAdapterTests(unittest.TestCase):
    ...
    def test_code_session_defaults_and_actions_delegate_to_legacy_module(self):
        ...
        self.assertEqual(tmux_workspace["summary"]["sessions_total"], 1)
        self.assertEqual(tmux_workspace["summary"]["sessions_live"], 1)
        self.assertEqual(tmux_workspace["summary"]["sessions_read_only"], 0)
        self.assertEqual(tmux_workspace["summary"]["sessions_previous"], 1)
        self.assertEqual(len(tmux_workspace["sessions"]), 1)
        self.assertEqual(len(tmux_workspace["previous_sessions"]), 1)
        self.assertFalse(tmux_workspace["previous_sessions"][0]["attached"])
        self.assertEqual(tmux_workspace["summary"]["estimated_tokens"], 123)
